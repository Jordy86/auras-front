...
const Commande = () => {
    ...
    const filteredCommandes = commandes
        ...
        .sort((a, b) => {
            ...
            if (sortBy === 'date_remise') return new Date(a.date_remise) - new Date(b.date_remise);
        ...
        <>
            ...
            <div className={`container-commande ${menuOpen ? "menu-open" : ""}`}>
                ...
                <div className='ajouter'>
                    <button className="btn-add" onClick={() => setModalAddOpen(true)}>Enregistrer une commande <i className='bi bi-plus'></i></button>
                </div>
